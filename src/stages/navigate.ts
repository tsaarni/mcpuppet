...
export class NavigateStage extends Stage {
  private readonly ssrf: boolean;
  private readonly settleDelayMs: number;

  constructor(options: NavigateOptions = {}) {
    super();
    this.ssrf = options.ssrf ?? false;
    this.settleDelayMs = options.settleDelayMs ?? 0;
  }
